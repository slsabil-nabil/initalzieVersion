            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div class="flex items-center">
                            <svg class="h-8 w-8 text-emerald-600 mr-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                ...
                <div class="flex items-center space-x-4 space-x-reverse">
                    <div class="flex items-center space-x-3 space-x-reverse">
                        <div
                            class="h-8 w-8 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200 shadow-lg hover:shadow-xl">
    ...
    <div class="flex">
        ...
        <div class="w-72 bg-white/90 backdrop-blur-md shadow-2xl border-l border-emerald-100 min-h-screen">
            ...
            <div class="p-6 border-b border-emerald-100">
                <div class="flex items-center">
                    <div
                        class="h-12 w-12 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <nav class="p-6">
                <div class="space-y-3">
                    ...
                    <a href="{{ route('admin.dashboard') }}"
                        ...
                        <div
                            class="flex items-center justify-center h-10 w-10 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-white/20' : 'bg-emerald-100 group-hover:bg-emerald-200' }} transition duration-200">
                            <svg class="h-5 w-5 {{ request()->routeIs('admin.dashboard') ? 'text-white' : 'text-emerald-600' }}"
                    ...
                    <a href="{{ route('admin.agencies') }}"
                        ...
                        <div
                            class="flex items-center justify-center h-10 w-10 rounded-lg {{ request()->routeIs('admin.agencies*') ? 'bg-white/20' : 'bg-teal-100 group-hover:bg-teal-200' }} transition duration-200">
                            <svg class="h-5 w-5 {{ request()->routeIs('admin.agencies*') ? 'text-white' : 'text-teal-600' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.add-agency') }}"
                        ...
                        <div
                            class="flex items-center justify-center h-10 w-10 rounded-lg {{ request()->routeIs('admin.add-agency') ? 'bg-white/20' : 'bg-cyan-100 group-hover:bg-cyan-200' }} transition duration-200">
                            <svg class="h-5 w-5 {{ request()->routeIs('admin.add-agency') ? 'text-white' : 'text-cyan-600' }}"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Dynamic Lists -->
                <a href="{{ route('admin.dynamic-lists') }}"
                    class="group flex items-center px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 hover:text-emerald-600 rounded-xl transition duration-200 {{ request()->routeIs('admin.dynamic-lists') ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-lg' : '' }}">
                    <div
                        class="flex items-center justify-center h-10 w-10 rounded-lg {{ request()->routeIs('admin.dynamic-lists') ? 'bg-white/20' : 'bg-emerald-100 group-hover:bg-emerald-200' }} transition duration-200">
                        <svg class="h-5 w-5 {{ request()->routeIs('admin.dynamic-lists') ? 'text-white' : 'text-emerald-600' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                        </svg>
                    </div>
                    <span class="mr-3 font-medium">إدارة القوائم</span>
                    @if (request()->routeIs('admin.dynamic-lists'))
                        <div class="mr-auto w-2 h-2 bg-white rounded-full"></div>
                    @endif
                </a>
